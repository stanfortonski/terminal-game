...
void Skills::set()
{
    switch (getSkillType())
    {
        case DARKNESS:
            BasicSkills::set(
                {"Cięcie Cienia", "Mroczny Grzmot", "Szelest Cienia", "Furia Mroku"},
        ...
        case LIGHT:
            BasicSkills::set(
                {"Jaskrawy cios", "Błysk Światła", "Słoneczna poświata", "Fala Światła"},
                {getSkillLevel(0), getSkillLevel(1), getSkillLevel(2), getSkillLevel(3)},
                {0.15, 0.2, 0.7, 0.8},
                {0, 10, 22, 32}
            );
        ...
        default:
            BasicSkills::set(
                {"Uderzenie", "Mocne Uderzenie", "Głębokie Rany", "Ostatnia Szansa"},
                {getSkillLevel(0), getSkillLevel(1), getSkillLevel(2), getSkillLevel(3)},
                {0.16, 0.25, 0.5, 0.7},
                {0, 12, 20, 26}
            );
