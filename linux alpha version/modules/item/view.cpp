...
{
	cout<<"********* "<<Color::FG_YELLOW<<getStringType()<<Color::DEFAULT<<" *********\n\n";
	...
	if (!descriptions.empty())
		cout<<endl<<Color::FG_PURPLE<<newLine(descriptions)<<Color::DEFAULT<<endl<<endl;
    ...
    {
        cout<<"Pozwala stworzyć: "<<Item(getBuildingComponents()[0])<<endl;
    }
